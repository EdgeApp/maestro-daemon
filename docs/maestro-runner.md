# maestro-runner (upstream README)

This is the README of [devicelab-dev/maestro-runner](https://github.com/devicelab-dev/maestro-runner),
the project maestro-d is forked from, kept here because everything it
describes still works — run it as `maestro-d test flows/`. The top-level
[README](../README.md) covers what the fork adds.
